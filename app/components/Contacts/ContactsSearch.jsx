 ...
 * 搜索联系人
 */
class ContactsSearch extends BaseComponent{
    constructor(){
        super();
    ...
    componentDidMount() {
        let headerData = {
            ...
            onSubmit:this.handelSearchSubmit.bind(this,null)
        }
    ...
    handelSearchSubmit(item,e){
        ...
        if(!Validation.isEmpty(keyword))
        {
            ...
            this.routerPush("/contacts/search/result",true);
        }
    }
...
export default Utils.altConnect(ContactsSearch, [ContactsStore]);